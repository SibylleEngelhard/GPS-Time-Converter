...
if not st.session_state.mobile_version:
    ...
    with rowa_col3:
        ...
        st.checkbox(
            "Mobile Version",
            help="Please select if you use the app on a smaller screen",
            on_change=change_version,
        )
    ...
    with row1_col1:
        ...
        if not st.session_state.show_local_time:
            placeholder_title.markdown(
                f'<h2 style="margin-bottom:0rem;margin-top:-1rem;text-align: right">UTC</h2>',
                unsafe_allow_html=True,
            )
        else:
            placeholder_title.markdown(
                f'<h2 style="margin-bottom:0rem;margin-top:-1rem;text-align: right">Local Time</h2>',
                unsafe_allow_html=True,
            )
    with row1_col2:
    ...
    with row1_col4:
        st.markdown(
            f'<h2 style="margin-bottom:0rem;margin-top:-1rem;text-align: left">GPS Time</h2>',
            unsafe_allow_html=True,
        )
...
# ----- Mobile Version for smaller screens -----
    ...
    # ---- Title
    st.markdown(
        '<h1 style="margin-bottom:0rem;margin-top:-1rem;text-align: center">GPS Time Converter</h1>',
        unsafe_allow_html=True,
    )
    st.markdown(
        '<h5 style="color:grey;margin-bottom:0rem;margin-top:-1rem;text-align: center">Convert between UTC/Local Time and GPS Time</h5>',
    ...
    st.checkbox(
        ...
        help="Change display to desktop version",
        on_change=change_version,
    )
    ...
    if st.session_state.show_local_time:
        ...
        text = st.session_state.selected_timezone_withoffset[i + 3 :]
        placeholder_showselectedoffset.markdown(
            f'<h4 style="color: blue;margin-bottom:0rem;text-align: center">'
            + text
            + "</h4>",
            unsafe_allow_html=True,
        )
